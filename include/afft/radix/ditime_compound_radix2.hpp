#ifndef AFFT_DITIME_COMPOUND_RADIX2_HPP
#define AFFT_DITIME_COMPOUND_RADIX2_HPP
...
namespace afft
{
    ...
    struct ComputeDitimeCompoundRadix2Substage
    {
            ...
            const typename Spec::operand *tw_imag_b_op)
        {
            ...
            ComputeDitimeCompoundRadix2Substage<Spec, StageFactor / 2, StageId + 1>::eval(
                alpha_real_a_op,
                alpha_real_b_op,
                alpha_imag_a_op,
                alpha_imag_b_op,
    ...
    struct ComputeDitimeCompoundRadix2Substage<Spec, 1, StageId>
    {
        static inline void eval(
            typename Spec::operand &alpha_real_a_op,
            typename Spec::operand &alpha_real_b_op,
    ...
    inline void do_ditime_compound_radix2_stage(
        ...
        const typename Spec::sample &scaling_factor)
    {
        ...
        ComputeDitimeCompoundRadix2Substage<Spec, n_samples_per_operand, 0>::eval(
            alpha_real_a_op,
            alpha_real_b_op,
            alpha_imag_a_op,
            alpha_imag_b_op,
