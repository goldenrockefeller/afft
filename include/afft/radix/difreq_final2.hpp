#ifndef AFFT_DIFREQ_FINAL2_HPP
#define AFFT_DIFREQ_FINAL2_HPP
...
namespace afft{
    ...
    inline void compute_difreq_final2_substage(
        ...
        const operand* final_tw_real_b_op,
        const operand* final_tw_imag_b_op
    ) {
        
        compute_difreq_final2_substage<Spec, StageFactor/2, StageId+1>(
            alpha_real_a_op,
            alpha_real_b_op,
            alpha_imag_a_op,
            alpha_imag_b_op,
        ...
        alpha_real_b_op = final_tw_imag_b_op[StageId] * beta_imag_b_op;
        alpha_imag_b_op = final_tw_imag_b_op[StageId] * beta_real_b_op;

        beta_real_b_op *= final_tw_real_b_op[StageId];
        beta_imag_b_op *= final_tw_real_b_op[StageId];

        beta_real_b_op -= alpha_real_b_op;
        beta_imag_b_op += alpha_imag_b_op;

        Spec::interleave(alpha_real_a_op, alpha_real_b_op, beta_real_a_op, beta_real_b_op);
        Spec::interleave(alpha_imag_a_op, alpha_imag_b_op, beta_imag_a_op, beta_imag_b_op);
        
    }

    template<typename Spec, std::size_t StageId>
    inline void compute_difreq_final2_substage<Spec, 1, StageId>(
        operand& alpha_real_a_op,
        operand& alpha_real_b_op,
        operand& alpha_imag_a_op,
        operand& alpha_imag_b_op,
    ...
    inline void do_difreq_final2_stage(
        ...
        operand final_tw_real_b_op[5];
        operand final_tw_imag_b_op[5];
        ...
        // COMPUTE  
        compute_difreq_final2_substage<Spec, n_samples_per_operand, 0>(
            alpha_real_a_op,
            alpha_real_b_op,
            alpha_imag_a_op,
            alpha_imag_b_op,
