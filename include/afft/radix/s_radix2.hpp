...
namespace afft
{
        ...
        const typename Spec::sample &scaling_factor)
    {
        ...
        {
        case 0:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 0>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 1:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 1>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 2:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 2>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 3:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 3>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 4:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 4>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 5:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 5>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 6:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 6>(
                out_real,
                out_imag,
                in_real,
                in_imag,
            ...
            break;
        case 7:
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 7>(
                out_real,
                out_imag,
                in_real,
                in_imag,
        ...
        case 8: // Up to interleave 256 support
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 8>(
                out_real,
                out_imag,
                in_real,
                in_imag,
        ...
        case 9: // Up to interleave 256 support
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 9>(
                out_real,
                out_imag,
                in_real,
                in_imag,
        ...
        case 10: // Up to interleave 256 support
            do_s_radix2_stage_impl<Spec, Rescaling, HasTwiddles, 10>(
                out_real,
                out_imag,
                in_real,
                in_imag,
