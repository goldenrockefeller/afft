#ifndef AFFT_DITIME_COMPOUND_RADIX4_HPP
#define AFFT_DITIME_COMPOUND_RADIX4_HPP
...
namespace afft
{
    ...
    struct ComputeDitimeCompoundRadix4Substage
    {
            ...
            const typename Spec::operand *tw_imag_d_op)
        {
            ...
            alpha_real_b_op = beta_real_b_op - alpha_real_b_op;
            alpha_imag_b_op += beta_imag_b_op;
            alpha_real_c_op = beta_real_c_op - alpha_real_c_op;
            alpha_imag_c_op += beta_imag_c_op;
            alpha_real_d_op = beta_real_d_op - alpha_real_d_op;
            alpha_imag_d_op += beta_imag_d_op;

            alpha_real_a_op = beta_real_a_op;
            alpha_imag_a_op = beta_imag_a_op;
            ...
            ComputeDitimeCompoundRadix4Substage<Spec, StageFactor / 4, StageId + 1>::eval(
                alpha_real_a_op,
                alpha_real_b_op,
                alpha_real_c_op,
                alpha_real_d_op,
    ...
    struct ComputeDitimeCompoundRadix4Substage<Spec, 1, StageId>
    {
        static inline void eval(
            typename Spec::operand &alpha_real_a_op,
            typename Spec::operand &alpha_real_b_op,
    ...
    template <typename Spec, std::size_t StageId>
    struct ComputeDitimeCompoundRadix4Substage<Spec, 2, StageId>
    {
        static inline void eval(
            typename Spec::operand &alpha_real_a_op,
            typename Spec::operand &alpha_real_b_op,
    ...
    inline void do_ditime_compound_radix4_stage(
        ...
        const typename Spec::sample &scaling_factor)
    {
            ...
            subfft_id++)
        {
            ...
            {
                Spec::load(beta_real_a_op, in_real_a);
                Spec::load(beta_imag_a_op, in_imag_a);
                Spec::load(beta_real_b_op, in_real_b);
                Spec::load(beta_imag_b_op, in_imag_b);
                Spec::load(beta_real_c_op, in_real_c);
                Spec::load(beta_imag_c_op, in_imag_c);
                Spec::load(beta_real_d_op, in_real_d);
                Spec::load(beta_imag_d_op, in_imag_d);
            ...
            ComputeDitimeCompoundRadix4Substage<Spec, n_samples_per_operand, 0>::eval(
                alpha_real_a_op,
                alpha_real_b_op,
                alpha_real_c_op,
                alpha_real_d_op,
