#ifndef AFFT_DIFREQ_FINAL4_HPP
#define AFFT_DIFREQ_FINAL4_HPP

#include <cstddef>
#include "afft/radix_primitives/load_edge_tw.hpp"

namespace afft{
    
    template<typename Spec, std::size_t StageFactor, std::size_t StageId>
    inline void compute_difreq_final4_substage(
        ...
        compute_difreq_final4_substage<Spec, StageFactor/4, StageId+1>(
            alpha_real_a_op,
            alpha_real_b_op,
            alpha_real_c_op,
            alpha_real_d_op,
        ...
        Spec::interleave(beta_real_a_op, beta_real_b_op, alpha_real_a_op, alpha_real_c_op);
        Spec::interleave(beta_real_c_op, beta_real_d_op, alpha_real_b_op, alpha_real_d_op);
        Spec::interleave(alpha_real_a_op, alpha_real_b_op, beta_real_a_op, beta_real_c_op);
        Spec::interleave(alpha_real_c_op, alpha_real_d_op, beta_real_b_op, beta_real_d_op);

        Spec::interleave(beta_imag_a_op, beta_imag_b_op, alpha_imag_a_op, alpha_imag_c_op);
        Spec::interleave(beta_imag_c_op, beta_imag_d_op, alpha_imag_b_op, alpha_imag_d_op);
        Spec::interleave(alpha_imag_a_op, alpha_imag_b_op, beta_imag_a_op, beta_imag_c_op);
        Spec::interleave(alpha_imag_c_op, alpha_imag_d_op, beta_imag_b_op, beta_imag_d_op);
    }

    template<typename Spec, std::size_t StageId>
    inline void compute_difreq_final4_substage<Spec, 1, StageId>(
        operand& alpha_real_a_op,
        operand& alpha_real_b_op,
        operand& alpha_real_c_op,
        operand& alpha_real_d_op,
    ...
    template<typename Spec, std::size_t StageId>
    inline void compute_difreq_final4_substage<Spec, 2, StageId>(
        operand& alpha_real_a_op,
        operand& alpha_real_b_op,
        operand& alpha_real_c_op,
        operand& alpha_real_d_op,
    ...
    inline void do_difreq_final4_stage(
        ...
        for (
            ...
            compute_difreq_final4_substage<Spec, n_samples_per_operand, 0>(
                alpha_real_a_op,
                alpha_real_b_op,
                alpha_real_c_op,
                alpha_real_d_op,
