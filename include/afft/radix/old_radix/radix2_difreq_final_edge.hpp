...
inline void do_radix2_difreq_final_edge_stage(
    ...
    in_real_b_op = out_imag_b_op * tw_imag_b_op;
    in_imag_b_op = out_real_b_op * tw_imag_b_op;

    out_real_b_op *= tw_real_b_op;
    out_imag_b_op *= tw_real_b_op;

    out_real_b_op -= in_real_b_op;
    out_imag_b_op += in_imag_b_op;

    OperandSpec::interleave(out_real_a_op, out_real_b_op);
    OperandSpec::interleave(out_imag_a_op, out_imag_b_op);
